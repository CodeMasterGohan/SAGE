...
async def list_libraries(
    ...
    Optimized: Uses iterative facet queries to avoid scanning the entire collection.
    """
    ...
    try:
        ...
        for hit in library_facets.hits:
            ...
            # Query 2: Get versions for THIS library
            # This is much faster than scrolling the entire collection if N_libraries is small
